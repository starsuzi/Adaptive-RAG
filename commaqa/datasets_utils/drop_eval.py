...
def evaluate_json(annotations: Dict[str, Any], predicted_answers: Dict[str, Any], quiet: bool) -> Tuple[float, float]:
    """
    ...
    for _, annotation in annotations.items():
        for qa_pair in annotation["qa_pairs"]:
            ...
            if query_id in predicted_answers:
                ...
                max_em_score = 0.0
                max_f1_score = 0.0
            if max_em_score == 0.0 and not quiet:
...
def evaluate_prediction_file(
    prediction_path: str, gold_path: str, output_path: Optional[str] = None, quiet: bool = False
) -> Tuple[float, float]:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--quiet", action="store_true", default=False, help="Do not print debug messages")
