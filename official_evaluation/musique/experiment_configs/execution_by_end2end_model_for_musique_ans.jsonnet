...
local fixture_path = 'fixtures/datasets/single_hop_all_retrieved_para_data.jsonl';
local train_data_path =
    if setting == 'full'
        then 'raw_data/musique_ans_single_hop_version_train.jsonl'
    else if setting == 'fixture'
        then fixture_path
    else '-';
local validation_data_path =
    if setting == 'full'
        then 'raw_data/musique_ans_single_hop_version_dev.jsonl'
    else if setting == 'fixture'
        then fixture_path
    else '-';
