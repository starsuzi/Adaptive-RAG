...
local fixture_path = 'fixtures/datasets/2wikimultihopqa_single_hop_version.jsonl';
local train_data_path =
    if setting == 'full'
        then 'raw_data/2wikimultihopqa_single_hop_version_train_20k.jsonl'
    else if setting == 'fixture'
        then fixture_path
    else '-';
local validation_data_path =
    if setting == 'full'
        then 'raw_data/2wikimultihopqa_single_hop_version_dev.jsonl'
    else if setting == 'fixture'
        then fixture_path
    else '-';
