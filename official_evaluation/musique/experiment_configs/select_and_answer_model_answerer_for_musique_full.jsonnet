...
local train_data_path =
    if setting == 'full'
        then 'serialization_dir/select_and_answer_model_selector_for_musique_full/predictions/musique_full_train.jsonl'
    else if setting == 'fixture'
        then fixture_path
    else '-';
local validation_data_path =
    if setting == 'full'
        then 'serialization_dir/select_and_answer_model_selector_for_musique_full/predictions/musique_full_dev.jsonl'
    else if setting == 'fixture'
        then fixture_path
    else '-';
...

{
    ...
    "trainer": {
        ...
        "num_epochs": num_epochs,
        "validation_metric": "+answer_sufficiency_f1",
    },
    "random_seed": seed,
    "numpy_seed": seed,
    "pytorch_seed": seed,
